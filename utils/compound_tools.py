...
def mol_to_graph_data(mol):
    ...
    ### Compute Gasteiger charges before iterating over atoms
    ...
    for i, atom in enumerate(mol.GetAtoms()):
        ...
        # Add atomic charge as a feature
        #data['atomic_charge'].append(float(atom.GetProp("_GasteigerCharge")))  # Use Gasteiger charge
...
def mol_to_geognn_graph_data_MMFF3d(mol):
    ...
    if len(mol.GetAtoms()) <= 400:
        ...
        #mol, atom_poses = Compound3DKit.get_MMFF_atom_poses(mol, numConfs=40)
    else:
